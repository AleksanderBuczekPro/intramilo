 ...
 */
final class Version20200504073429 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE paragraph (id INT AUTO_INCREMENT NOT NULL, sheet_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, place INT NOT NULL, INDEX IDX_7DD398628B1206A5 (sheet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE paragraph ADD CONSTRAINT FK_7DD398628B1206A5 FOREIGN KEY (sheet_id) REFERENCES sheet (id)');
