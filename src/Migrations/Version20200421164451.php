 ...
 */
final class Version20200421164451 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attachment ADD author_id INT NOT NULL, ADD size INT NOT NULL, ADD mime_type VARCHAR(255) NOT NULL, ADD original_name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE attachment ADD CONSTRAINT FK_795FD9BBF675F31B FOREIGN KEY (author_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_795FD9BBF675F31B ON attachment (author_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attachment DROP FOREIGN KEY FK_795FD9BBF675F31B');
        $this->addSql('DROP INDEX IDX_795FD9BBF675F31B ON attachment');
        $this->addSql('ALTER TABLE attachment DROP author_id, DROP size, DROP mime_type, DROP original_name');
