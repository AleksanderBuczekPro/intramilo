 ...
 * @UniqueEntity(
 *  fields={"title"},
 *  message="Une autre anonce possède déjà ce titre, merci de le modifier"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min=20, max=255, minMessage="L'introduction doit faire au moins 20 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, max=255, minMessage="Le contenu doit faire au moins 100 caractères")
     */
    private $content;
